...
if __name__ == "__main__":
    ...
    parser.add_argument('--cmake_option', action='append', help="Adds the ability to modify the cmake list")
    parser.add_argument('--build_flags',action='append',help="prepare flags for building")
    parser.add_argument('--whitelist', help="Add an ability to connect a JSON file that include list of the OpenCV functions needed for developing a project")
...
#     ]
    ...
    if args.whitelist:
        os.environ["OPENCV_JS_WHITELIST"] = args.whitelist
